...
namespace SharedSerialization
{
    ...
    public class Solution
    {
        ...
        public bool CheckDifficulty()
        {
            try
            {
                BitArray packed = new BitArray(48 * 29);
                byte[] packedSolution = new byte[174]; // 48*proof_size/8 padded
                int position = 0;
        ...
        //    try
        //    {
        //        BitArray packed = new BitArray(48 * 32);
        //        byte[] packedSolution = new byte[174]; // 32*proof_size/8 padded
        //        int position = 0;
        //        foreach (var n in nonces)
        //        {
        //            for (int i = 0; i < 32; i++)
